...
class IncidentAlpha(EqualityMixin):
    ...
    :meth:`IncidentAlpha.from_hdf5`, :meth:`IncidentAlpha.from_ace`, and
    :meth:`IncidentAlpha.from_endf`.
    ...
    def __repr__(self):
        return "<IncidentAlpha: {}>".format(self.name)
    ...
    def add_temperature_from_ace(self, ace_or_filename, metastable_scheme='nndc'):
        ...
        data = IncidentAlpha.from_ace(ace_or_filename, metastable_scheme)
    ...
    def from_njoy(cls, filename, temperatures=None, evaluation=None, **kwargs):
        ...
        **kwargs
        ...
        Returns
        -------
        data : openmc.data.IncidentAlpha
            Incident neutron continuous-energy data
