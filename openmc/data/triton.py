...
class IncidentTriton(EqualityMixin):
    ...
    :meth:`IncidentTriton.from_hdf5`, :meth:`IncidentTriton.from_ace`, and
    :meth:`IncidentTriton.from_endf`.
    ...
    def __repr__(self):
        return "<IncidentTriton: {}>".format(self.name)
    ...
    def add_temperature_from_ace(self, ace_or_filename, metastable_scheme='nndc'):
        ...
        data = IncidentTriton.from_ace(ace_or_filename, metastable_scheme)
    ...
    def from_ace(cls, ace_or_filename, metastable_scheme='nndc'):
        ...
        if not xs.endswith('r'):
            raise TypeError(
                "{} is not a continuous-energy triton ACE table.".format(ace))
    ...
    def from_njoy(cls, filename, temperatures=None, evaluation=None, **kwargs):
        ...
        **kwargs
        ...
        Returns
        -------
        data : openmc.data.IncidentTriton
            Incident neutron continuous-energy data
