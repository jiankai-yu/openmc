...
class IncidentDeuteron(EqualityMixin):
    ...
    :meth:`IncidentDeuteron.from_hdf5`, :meth:`IncidentDeuteron.from_ace`, and
    ...
    def __repr__(self):
        return "<IncidentDeuteron: {}>".format(self.name)
    ...
    def add_temperature_from_ace(self, ace_or_filename, metastable_scheme='nndc'):
        ...
        data = IncidentDeuteron.from_ace(ace_or_filename, metastable_scheme)
    ...
    def from_ace(cls, ace_or_filename, metastable_scheme='nndc'):
        ...
        if not xs.endswith('o'):
            raise TypeError(
                "{} is not a continuous-energy deuteron ACE table.".format(ace))
    ...
    def from_njoy(cls, filename, temperatures=None, evaluation=None, **kwargs):
        ...
        **kwargs
        ...
        Returns
        -------
        data : openmc.data.IncidentDeuteron
            Incident neutron continuous-energy data
